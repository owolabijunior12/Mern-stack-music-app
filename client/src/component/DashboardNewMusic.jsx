...
const DashboardNewMusic = () => {
  ...
  const [musicImageUrl, setMusicsImageUrl] = useState(null);
  ...
  const saveMusic = () => {
    if (!musicImageUrl || !audioAsset || !musicName) {
      setSetAlert("error");
      ...
      saveNewMusic(data).then((res) => {
        getAllMusics().then((musics) => {
          dispatch({ type: actionType.SET_MUSICS, allMusics: musics.data });
        });
      });
      setSetAlert("success");
  ...
  return (
    <div className="flex items-center justify-evenly w-full flex-wrap">      
      ...
      <div className="flex flex-col items-center justify-center gap-4 ">
        <h1 className="text-4xl"> Artist Details</h1>
        <input
          type="text"
...
export const AddNewAlbum = () => {
  ...
  return (
    <div className="flex items-center justify-evenly w-full flex-wrap">
      ...
      <div className="flex flex-col items-center justify-center gap-4 ">
      <h1 className="text-4xl"> Album Details</h1>
        <input
          type="text"
          placeholder="Artist Name"
          className="w-full lg:w-300 p-3 rounded-md text-base font-semibold text-textColor outline-none shadow-sm border border-textColor bg-transparent"
